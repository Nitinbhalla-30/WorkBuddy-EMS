...
// Q&A thread on a reimbursement claim between HR/Admin and the employee.
export default function ReimbursementThread({
  claim,
  viewerRole,
  viewerId,
  nameOf,
  ...
  const canPost = pending && (isAdmin || viewerId === claim.employeeId)
